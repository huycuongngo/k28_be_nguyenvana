...
const createNewMovie = async (req, res) => {
  ...
  try {
    ...
    handleResponseSuccess(res, 201, "Create movie successfully", { newMovie })
  } catch (error) {
    console.log("error", error)
    handleResponseError(res, 500, "Internal server error")
  }
